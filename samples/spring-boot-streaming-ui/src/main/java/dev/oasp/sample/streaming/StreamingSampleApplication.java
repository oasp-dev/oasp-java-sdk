...
/**
 * Entry point for the live-streaming (Server-Sent Events) sample app.
 *
 ...
 * The static single-page app there opens an SSE connection to
 * {@code /api/converse} and renders assistant text chunks as they stream in.
 */
@SpringBootApplication
public class StreamingSampleApplication {

    public static void main(String[] args) {
        SpringApplication.run(StreamingSampleApplication.class, args);
    }
}
